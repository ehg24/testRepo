...
\begin{exercise}
Given that $r(v)=-2 v^2-4 v-4$, evaluate $r(-0.4)$. 
...
The value of the function $r(v)=-2 v^2-4 v-4$,
evaluated at $v=-0.4$, is \answer{-2.72}.
%\end{solution}
\end{exercise}
...
\end{hint}
\begin{hint}
Now from this position, move up or down until you reach the curve. 
The value of $R(3)$ is the height of the curve at the point $n=3$.
\end{hint}
